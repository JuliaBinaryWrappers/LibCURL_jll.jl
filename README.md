...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/7df3636dabfe72a1d13d8bb11ed829fe17ccc4e3/L/LibCURL/LibCURL@8/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* compressed archive: https://curl.se/download/curl-8.21.0.tar.gz (SHA256 checksum: `d9b327997999045a24cda50f3983e69e51c516bd8be6ef9842fc7f99135e33bb`)
* files in directory, relative to originating `build_tarballs.jl`: [`../patches`](https://github.com/JuliaPackaging/Yggdrasil/tree/7df3636dabfe72a1d13d8bb11ed829fe17ccc4e3/L/LibCURL/LibCURL@8/patches)
