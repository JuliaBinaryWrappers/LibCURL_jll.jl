...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/740c2a15a79c58b9383dedf09944d31ac1dea3dd/L/LibCURL/LibCURL@8/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* compressed archive: https://curl.se/download/curl-8.18.0.tar.gz (SHA256 checksum: `e9274a5f8ab5271c0e0e6762d2fce194d5f98acc568e4ce816845b2dcc0cf88f`)
* files in directory, relative to originating `build_tarballs.jl`: [`../patches`](https://github.com/JuliaPackaging/Yggdrasil/tree/740c2a15a79c58b9383dedf09944d31ac1dea3dd/L/LibCURL/LibCURL@8/patches)
